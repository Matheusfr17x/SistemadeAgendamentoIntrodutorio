    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            <ul class="list-group list-group-flush">
                ...
                <button class="list-group-item list-group-item-action" onclick="window.location.href = '';">Compromissos da semana</button>
                <button class="list-group-item list-group-item-action" onclick="window.location.href = '';">Compromissos do mês</button>
                <button class="list-group-item list-group-item-action" onclick="window.location.href = '';">Compromisso do semestre</button>
            </ul>
        </div>
